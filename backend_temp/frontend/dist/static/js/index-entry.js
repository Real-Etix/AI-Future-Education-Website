const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["static/js/History-chunk.js","static/css/History-asset.css","static/js/Chat-chunk.js","static/css/Chat-asset.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
const _sfc_main$2 = {
  ...
  methods: {
    ...
    async createChatBlank() {
      ...
      let chatID;
      const url = "/chat-api/create-chat";
      await fetch(url, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
...
const _hoisted_11$1 = { class: "text" };
  ...
  return openBlock(), createElementBlock("aside", null, [
    ...
    createBaseVNode("div", _hoisted_3$1, [
      withDirectives(createBaseVNode("input", {
        ...
        placeholder: "創建會話",
        onKeyup: _cache[1] || (_cache[1] = withKeys((...args) => _ctx.createChatBlank && _ctx.createChatBlank(...args), ["enter"]))
      }, null, 544), [
    ...
    _cache[8] || (_cache[8] = createBaseVNode("div", { class: "menu-heading" }, [
    ...
    _cache[9] || (_cache[9] = createBaseVNode("div", { class: "flex" }, null, -1)),
    createBaseVNode("div", _hoisted_8$1, [
      ...
      createBaseVNode("div", _hoisted_10$1, [
        createBaseVNode("button", {
          ...
          createBaseVNode("span", _hoisted_11$1, toDisplayString(_ctx.userID), 1),
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
    _ctx.renderSidebar ? (openBlock(), createBlock(_component_Sidebar, {
      key: 0,
      head: "XXChatBot",
      userID: _ctx.userID
    }, null, 8, ["userID"])) : createCommentVNode("", true),
    createBaseVNode("div", _hoisted_1$1, [
      createVNode(_component_RouterView, {
        userID: _ctx.userID,
        onTempUpdateChat: _ctx.forceRerender
      }, null, 8, ["userID", "onTempUpdateChat"])
    ])
  ], 64);
}
...
const TemplateImage = "/static/images/template-pic.jpeg";
const valueList = [
  {
    title: "承諾",
    img: TemplateImage,
...
const _hoisted_2 = { class: "main-input" };
const _hoisted_3 = { class: "upload" };
const _hoisted_4 = { class: "category-select" };
const _hoisted_5 = { class: "overlap" };
const _hoisted_6 = { class: "button-inline" };
const _hoisted_7 = {
  key: 0,
  class: "item-select"
};
...
const _hoisted_18 = { class: "img" };
const _hoisted_19 = ["src"];
function render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_router_link = resolveComponent("router-link");
  return openBlock(), createElementBlock("main", _hoisted_1, [
    _cache[7] || (_cache[7] = createBaseVNode("div", { class: "brand-title" }, [
      createBaseVNode("h1", null, "XXChatBot")
    ], -1)),
    createBaseVNode("div", _hoisted_2, [
      withDirectives(createBaseVNode("textarea", {
        id: "main-input-area",
        rows: "5",
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.newChatTopic = $event),
        placeholder: "今天想要學習什麼價值觀"
      }, null, 512), [
        [vModelText, _ctx.newChatTopic]
      ]),
      createBaseVNode("div", _hoisted_3, [
        createBaseVNode("button", {
          onClick: _cache[1] || (_cache[1] = ($event) => _ctx.createChatByTopic())
        }, _cache[5] || (_cache[5] = [
          createBaseVNode("span", { class: "material-symbols-outlined" }, "arrow_upward", -1)
        ]))
      ])
    ]),
    createBaseVNode("div", _hoisted_4, [
      createBaseVNode("div", _hoisted_5, [
        createBaseVNode("div", _hoisted_6, [
          createBaseVNode("button", {
            onClick: _cache[2] || (_cache[2] = ($event) => _ctx.changeShowing(0)),
            class: normalizeClass({ "active": _ctx.isShowing === 0 })
          }, "故事推薦", 2),
          createBaseVNode("button", {
            onClick: _cache[3] || (_cache[3] = ($event) => _ctx.changeShowing(1)),
            class: normalizeClass({ "active": _ctx.isShowing === 1 })
          }, "價值觀學習", 2),
          createBaseVNode("button", {
            onClick: _cache[4] || (_cache[4] = ($event) => _ctx.changeShowing(2)),
    ...
    createVNode(Transition, {
      ...
      default: withCtx(() => [
        _ctx.isShowing == 0 ? (openBlock(), createElementBlock("div", _hoisted_7, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.storyList, (story) => {
            return openBlock(), createElementBlock("button", {
              class: "button",
              onClick: ($event) => _ctx.createChatWithStory(story.id, story.title)
            }, [
              createBaseVNode("label", _hoisted_9, toDisplayString(story.title), 1),
        ...
        ])) : _ctx.isShowing == 1 ? (openBlock(), createElementBlock("div", _hoisted_12, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.valueList, (value) => {
            return openBlock(), createBlock(_component_router_link, {
              ...
              default: withCtx(() => [
                createBaseVNode("label", _hoisted_13, toDisplayString(value.title), 1),
        ...
        ])) : _ctx.isShowing == 2 ? (openBlock(), createElementBlock("div", _hoisted_16, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.consultList, (consult) => {
            return openBlock(), createBlock(_component_router_link, {
              ...
              default: withCtx(() => [
                createBaseVNode("label", _hoisted_17, toDisplayString(consult.title), 1),
...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: () => __vitePreload(() => import("./Placeholder-chunk.js"), true ? [] : void 0)
    },
    {
      path: "/history",
      name: "history",
      component: () => __vitePreload(() => import("./History-chunk.js"), true ? __vite__mapDeps([0,1]) : void 0)
    },
    {
      path: "/chat/:id/",
      name: "chat",
      component: () => __vitePreload(() => import("./Chat-chunk.js"), true ? __vite__mapDeps([2,3]) : void 0),
      props: true
    }
  ]
});
